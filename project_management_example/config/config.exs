...
url: [host: "localhost"],
secret_key_base: "PYNW31k5uxfmT2pYFX0xOoH2LRmwtwJkwdHRFICi15KaqGt04cn8cAXUJTdUXRpq",
render_errors: [view: ProjectManagementExampleWeb.ErrorView, accepts: ~w(json)],
